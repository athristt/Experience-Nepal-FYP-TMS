...
<!--four-grids here-->
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits" onclick="location.href='manage-users.php'">
							<div class="icon">
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo" onclick="location.href='manage-bookings.php'">
							<div class="icon">
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls" onclick="location.href='manage-enquires.php'">
							<div class="icon">
...
$cnt2=$query2->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree" onclick="location.href='manage-packages.php'">
							<div class="icon">
...
$cnt3=$query3->rowCount();
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls" onclick="location.href='manageissues.php'">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							</div>
							<div class="four-text">
